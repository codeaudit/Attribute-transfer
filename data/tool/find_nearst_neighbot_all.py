...
sens=[]
arrs=[]
f1=open('../'+main_data+'/sentiment.train.'+str(1-string.atoi(sys.argv[1]))+'.template.'+main_function+'.emb','r')
for line in f1:
...
f=open('../'+main_data+'/sentiment.test.'+sys.argv[1]+'.template.'+main_function+'.emb','r')
fw=open('../'+main_data+'/sentiment.test.'+sys.argv[1]+'.template.'+main_function+'.emb.result','w')
for line in f:
